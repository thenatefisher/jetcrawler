...
module FetchControllerIndex

    def FetchControllerIndex.decode_string(str) 
        return URI.unescape str
    end

    def FetchControllerIndex.fetch_cdc(url)
        ...
        tS40436f_75 = self.decode_string(prefix + ":" + chlg.to_s + ":" + slt.to_s + ":" + crc.to_s)
