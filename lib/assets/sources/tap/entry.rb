    ...
    def create_collection
        ...
        for cat in ["Jet", "TurboProp"]
            ...
            begin
                ...
                response = `curl -H "Accept-Language: en-US,en;q=0.5" -H "Accept-Encoding: gzip, deflate" -H "Content-Type: application/x-www-form-urlencoded; charset=UTF-8" --cookie "#{cookie}" -A "#{agent}" --compressed "#{index_page_url}"`
